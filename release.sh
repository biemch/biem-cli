...
# - npm (for versioning)
# - Commitizen (`cz`) installed and configured
...
cz --config .config/commitizen/.cz.json changelog --template .config/commitizen/changelog-template.j2 --file-name CHANGELOG.md
